...
public partial class FruitDropper : Area2D {
    ...
    /// <summary>
    /// Attempts to immediately reposition dropper
    /// </summary>
    /// <param name="position"></param>
    public void TryRepositionDropper(Vector2I position) {
        if (!HasAllComponents()) return;
        
    }

    /// <summary>
    /// Attempts to translate dropper over time
    /// </summary>
    /// <param name="direction"></param>
    public void TryTranslatingDropper(Vector2I direction) {
        if (!HasAllComponents()) return;
